...
class NotificationController {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (receivedAction.actionType == ActionType.SilentAction ||
      ...
      Note.navigatorKey.currentState?.pushNamedAndRemoveUntil(
          '/notification-page',
          (route) =>
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = Note.navigatorKey.currentContext!;
    await showDialog(
        context: context,
...
class Note extends StatefulWidget {
  ...
  @override
  State<Note> createState() => _AppState();
}

class _AppState extends State<Note> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      navigatorKey: Note.navigatorKey,
        ...
        leading: BackButton(
          onPressed: () {
            /*Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const main.MyHomePage(),
              ),
            );*/
          },
        ),
